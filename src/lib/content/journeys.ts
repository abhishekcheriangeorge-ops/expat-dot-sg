...
export async function getCondoEvChargerClearPlaybook(): Promise<LeavingPlaybook | null> {
  return getPlaybookByFilename("condo-ev-charger-clear.json");
}

export async function getUtilityMeterPhotoHandoffPlaybook(): Promise<LeavingPlaybook | null> {
...
export async function getParkingIuErpExitPlaybook(): Promise<LeavingPlaybook | null> {
  return getPlaybookByFilename("parking-iu-erp-exit.json");
}
