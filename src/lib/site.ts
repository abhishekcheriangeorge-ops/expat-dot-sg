...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        href: "/guides/condo-fire-alarm-smoke-detector-tenant-drills",
        blurb: "SCDF drills, false alarms, and tenant detector duties.",
      },
      {
        label: "Neighbourhood guides",
        href: "/neighbourhoods",
        blurb: "Novena, Newton, Toa Payoh Central, Bukit Timah, and more.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "ActiveSG yoga & pilates",
        href: "/guides/activesg-yoga-pilates-class-booking-singapore",
        blurb: "Standard Rate mats, peak release, attire norms.",
      },
      {
