...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "Standby generator & ATS testing",
        href: "/guides/condo-standby-generator-ats-testing-notices-tenants",
        blurb: "MA genset calendars, brief transfer windows, and WFH planning.",
      },
      {
        label: "Neighbourhood guides",
        href: "/neighbourhoods",
        blurb: "Kembangan Fringe, Bedok North West, Guillemard East, and more.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "ActiveSG athletics track",
        href: "/guides/activesg-athletics-track-booking-singapore",
        blurb: "Standard Rate lanes / programmes — not stadium court or takraw hire.",
      },
      {
