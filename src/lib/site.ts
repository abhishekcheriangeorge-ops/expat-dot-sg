...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "BBQ & function-room booking",
        href: "/guides/condo-bbq-function-room-booking-tenants",
        blurb: "MCST pits, guest caps, and cleaning deposits.",
      },
      {
        label: "Lightning protection & earth-pit notices",
        href: "/guides/condo-lightning-protection-earth-pit-inspection-notices-tenants",
        blurb: "LPS / earth-pit inspection calendars — not genset or gondola jobs.",
      },
      {
        label: "Neighbourhood guides",
        href: "/neighbourhoods",
        blurb: "Siglap Fringe, Frankel East, Opera Estate West, and more.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "ActiveSG cycling circuit",
        href: "/guides/activesg-cycling-circuit-booking-singapore",
        blurb: "Standard Rate circuit sessions — not athletics track or court hire.",
      },
      {
        label: "ActiveSG table tennis",
        href: "/guides/activesg-table-tennis-booking-singapore",
        blurb: "Standard Rate bookings, peak release, bat/ball norms.",
      },
      {
