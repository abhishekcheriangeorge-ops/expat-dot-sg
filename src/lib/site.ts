...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "Facade & gondola access notices",
        href: "/guides/condo-facade-gondola-access-notices-tenants",
        blurb: "BMU schedules, balcony clearance, and MA damage trails.",
      },
      {
        label: "Neighbourhood guides",
        href: "/neighbourhoods",
        blurb: "Kaki Bukit Fringe, Eunos North, Paya Lebar West, and more.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "ActiveSG sepak takraw",
        href: "/guides/activesg-sepak-takraw-booking-singapore",
        blurb: "Standard Rate courts / programmes — not netball or badminton hire.",
      },
      {
