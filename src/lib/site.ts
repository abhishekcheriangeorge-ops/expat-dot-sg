...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "Strep-throat exclusion ops",
        href: "/guides/dual-career-kids-strep-throat-school-exclusion-singapore",
        blurb: "Written return clocks, swab forks, sibling freezes.",
      },
      {
        label: "Curriculum-evening ops",
        href: "/guides/international-school-curriculum-evening-ops-dual-career-singapore",
        blurb: "Slot clocks, question scripts, sibling coverage.",
      },
      {
        label: "Ringworm / tinea exclusion ops",
        href: "/guides/dual-career-kids-ringworm-tinea-school-exclusion-singapore",
        blurb: "Written return clocks, kit freezes, swim/PE holds.",
      },
      {
        label: "Weekday sports-fixture ops",
        href: "/guides/international-school-sports-fixture-weekday-ops-dual-career-singapore",
      ...
      {
        label: "Fifth-disease / slapped-cheek exclusion ops",
        href: "/guides/dual-career-kids-fifth-disease-slapped-cheek-school-exclusion-singapore",
        blurb: "Written return clocks, pregnancy notes, sibling freezes.",
      },
      {
        label: "Language-evening ops",
        href: "/guides/international-school-language-evening-ops-dual-career-singapore",
      ...
      {
        label: "Concert / recital ops",
        href: "/guides/international-school-concert-recital-ops-dual-career-singapore",
        blurb: "Call times, costume blackouts, hall-adult owners.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        label: "Drama-studio waiting belonging",
        href: "/guides/drama-studio-waiting-parent-belonging-singapore",
        blurb: "Repeat corridor hellos without casting politics.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        blurb: "Under-21 cliff — Student’s Pass / own EP before the birthday.",
      },
      {
        label: "DP LOC renewal pack",
        href: "/guides/dp-loc-renewal-local-hire-cpf-pack-singapore",
        blurb: "Local Qualifying Salary hire + three CPF months before renew.",
      },
      {
