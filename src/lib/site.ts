...
export const pillars: Pillar[] = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        blurb: "New IPA before resign; IR21 withhold even if you stay.",
      },
      {
      ...
      },
      {
        ...
        blurb: "5-day address/mobile clock; FWTES condo consent traps.",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        blurb: "No MediShield on EP; hospital LOG; maternity gaps.",
      },
      {
