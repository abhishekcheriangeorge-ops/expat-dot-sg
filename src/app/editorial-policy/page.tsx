      ...
      <div className="mt-14 max-w-[var(--max-prose)] space-y-10 text-base leading-relaxed text-ink-muted">
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            SCs, citizenship confirmation letters, foreign probate
            resealing for Singapore banks, EP passport update before
            travel, FDW cancellation when leaving, EP renewal NOA /
            document asks, Re-Entry Permit rules and passport transfers,
            citizenship application and ORAL, adult SC renunciation, NRIC
            loss / address / re-registration / name change, NS, exits).
            When agencies
            publish dated
