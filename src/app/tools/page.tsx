...
export const metadata: Metadata = buildPageMetadata({
  title: "Tools",
  description:
    "Singapore expat utilities — first-month cash, lease stamp duty, cost-of-living estimate, Employment Pass salary threshold, school withdrawal notice, car/COE exit, and HDB reno deposit sketch.",
  path: "/tools",
});
...
const tools = [
  ...
  },
  {
    ...
    title: "HDB reno deposit",
    summary:
      "Sketch renovation permit deposit refund timing and cash at risk after inspection.",
  },
] as const;
