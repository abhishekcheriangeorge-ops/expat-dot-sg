...
const STATIC_PATHS: Array<{
  ...
  { path: "/journeys/loc-dp-work-rights", changeFrequency: "monthly", priority: 0.75 },
  { path: "/journeys/condo-mcst-exit", changeFrequency: "monthly", priority: 0.75 },
  { path: "/journeys/mail-forward-exit", changeFrequency: "monthly", priority: 0.75 },
  ...
  { path: "/tools/school-withdrawal", changeFrequency: "monthly", priority: 0.65 },
  { path: "/tools/car-coe-exit", changeFrequency: "monthly", priority: 0.65 },
  { path: "/tools/hdb-reno-deposit", changeFrequency: "monthly", priority: 0.65 },
