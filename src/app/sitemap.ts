...
const STATIC_PATHS: Array<{
  ...
  { path: "/journeys/family-joining", changeFrequency: "monthly", priority: 0.75 },
  {
  ...
  { path: "/tools/ipa-window", changeFrequency: "monthly", priority: 0.65 },
  ...
  { path: "/tools/sim-otp-keep", changeFrequency: "monthly", priority: 0.65 },
