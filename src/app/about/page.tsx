        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              DP LOC CPF hire-timing edges, STVP extension vs Special Pass edges, AL encashment×IR21 tax-clearance edges, EP probation×new IPA overlap, training-bond final-pay deduction edges, FCF 14-day relist/ad-match edges, WHP/TEP→EP handoff, graduate LTVP→EP sponsor packaging, S Pass levy/quota mid-cycle shocks, EntrePass→EP founder exit, S Pass→EP upgrade packaging, COMPASS C2 degree verification edges, Tech.Pass→ONE salary composite, LTVP/PLOC→EP conversion edges, EP notify-MOM address/passport edges, ONE Pass outstanding-achievements evidence, EP job-change IR21 withhold edges, PEP exit-to-EP/PR timing, EP renewal NOA asks, pass cancellations) are checked against
