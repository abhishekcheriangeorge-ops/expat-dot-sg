        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              DP re-sponsor when principal changes EP, Student’s Pass
              work-hour / vacation exemption, SRS exit withholding for
              non-residents, REP passport transfers, EP renewal NOA asks,
              pass cancellations) are checked against live ICA / MOM / MHA
              text before we ship.
            </li>
            <li>
